...
class Scientist extends EMP {
    ...
    public String toString() {
        return "Name: " + name + ", id: " + id + ", no_of_publication: " + no_of_publication + ", experience: "
                + experience;
    }
}
...
class Test {
    public static void main(String[] args) {
        ...
        EMP sc = new Scientist("Suhotra", 987654, 10, 5);
        EMP ds = new Dscientist("Soumyadeep", 264828, 13, 8, 4);
